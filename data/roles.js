const roleData = {
  Mafia: {
    ...
    Surgeon: {
      alignment: "Village",
      category: "Protective",
      tags: ["Convert Saver", "Protective", "Killing", "Night Saver", "Visiting"],
      description: [
    ...
    Chandler: {
      alignment: "Village",
      category: "Gifting",
      tags: ["Gifting", "Information", "Items", "Candle", "Visit Interaction", "Visiting"],
      description: [
    ...
    Falconer: {
      alignment: "Village",
      category: "Gifting",
      tags: ["Gifting", "Information", "Items", "Falcon", "Visit Interaction", "Visiting"],
      description: [
    ...
    Missionary: {
      alignment: "Village",
      category: "Gifting",
      tags: ["Gifting", "Convert Saver", "Items", "Tract", "Protective", "Visiting"],
      description: [
    ...
    Santa: {
      alignment: "Village",
      category: "Gifting",
      tags: ["Gifting", "Items", "Graveyard", "Investigative", "Alignments", "Visiting", "Information","Self Blocking"],
      description: [
    ...
    Psychic: {
      alignment: "Village",
      category: "Investigative",
      tags: ["Investigative", "Alignment", "Visiting", "Reflexive", "Self Blocking"],
      description: [
    ...
    Avenger: {
      ...
      tags: ["Night-acting", "Killing", "Gun", "Items","Visiting", "Day Killer"],
      description: [
    ...
    Sailor: {
      ...
      newlyAdded: true,
      category: "Night-acting",
      tags: ["Night-acting", "Mind Rot", "Unkillable", "Condemn Immune","Visiting"],
      description: [
    ...
    Jailer: {
      alignment: "Village",
      category: "Killing",
      tags: ["Killing", "Meeting", "Role Blocker", "Condemn", "Dusk","Night Killer"],
      description: [
    ...
    Poisoner: {
      alignment: "Mafia",
      category: "Killing",
      tags: ["Killing", "Poison", "Malicious Effects","Visiting","Night Killer"],
      description: [
    ...
    Interrogator: {
      alignment: "Mafia",
      tags: ["Meeting", "Killing", "Condemn", "Role Blocker", "Dusk","Night Killer"],
      description: [
        "If no one was condemned, chooses a player to jail after each day meeting.",
        "Meets with the prisoner at night and the prisoner cannot perform actions or attend other meetings or be targeted.",
        "Decides whether or not the prisoner should be executed.",
    ...
    Enforcer: {
      alignment: "Mafia",
      tags: ["Convert Saver", "Protective", "Conversion", "Traitor","Visiting"],
      description: [
    ...
    Bartender: {
      alignment: "Mafia",
      tags: ["Night-acting", "Effects", "Alcoholics", "Role Blocker","Visiting"],
      description: [
    ...
    Inquisitor: {
      alignment: "Cult",
      category: "Conversion",
      tags: ["Conversion", "Kills Cultist", "Killing","Visiting","Day Killer"],
      description: [
    ...
    "Witch Doctor": {
      alignment: "Cult",
      category: "Conversion",
      tags: ["Conversion", "Kills Cultist", "Protective", "Night Saver","Visiting"],
      description: [
    ...
    Fungoid: {
      alignment: "Cult",
      category: "Speaking",
      tags: ["Speaking", "Speech", "Silence", "Blind", "Clueless", "Deafen","Visiting"],
      description: [
    ...
    Gremlin: {
      alignment: "Cult",
      category: "Chaos",
      tags: ["Conversion", "Items", "Cult Items", "Insanity", "Magic","Visiting"],
      description: [
    ...
    Lich: {
      alignment: "Cult",
      category: "Demon",
      tags: ["Endangered", "Killing", "Banished", "Setup Changes", "Mind Rot","Visiting","Night Killer"],
      newlyAdded: true,
      description: [
        "Each night, may choose a player to kill.",
    ...
    Nyarlathotep: {
      alignment: "Cult",
      category: "Demon",
      tags: ["Endangered", "Killing", "Win Con", "Deception", "False Mode","Visiting","Night Killer",],
      newlyAdded: true,
      description: [
        "Each night, may choose a player to kill.",
    ...
    Satyr: {
      alignment: "Cult",
      category: "Demon",
      tags: ["Endangered", "Killing", "Mind Rot", "Neighbors", "Banished","Visiting","Night Killer"],
      newlyAdded: true,
      description: [
        "Each night, may choose a player to kill.",
    ...
    Snallygaster: {
      alignment: "Cult",
      category: "Demon",
      tags: ["Endangered", "Killing", "Extra Night Deaths","Visiting","Night Killer"],
      newlyAdded: true,
      description: [
    ...
    Vampire: {
      alignment: "Cult",
      category: "Demon",
      tags: ["Killing", "Condemn", "Voting", "Setup Changes","Visiting","Night Killer"],
      newlyAdded: true,
      description: [
    ...
    Monk: {
      alignment: "Independent",
      tags: ["Voting", "Night Saver", "Protective", "Condemn Immune","Visiting"],
      description: [
        "Has no voting power.",
    ...
    Yandere: {
      alignment: "Independent",
      tags: ["Killing", "Must Act", "Linked", "Last Two","Visiting","Hostile"],
      description: [
        "Falls in love with another player once per game.",
    ...
    Hellhound: {
      alignment: "Independent",
      tags: ["Killing", "Roles", "Last Two", "Immortal", "Condemn Immune","Visiting","Hostile"],
      description: [
    ...
    Usurper: {
      alignment: "Independent",
      tags: ["Mafia", "Mafioso", "Meeting", "AnonymizeMeeting", "Cultist","Visiting","Hostile"],
      description: [
    ...
    Mutineer: {
      alignment: "Independent",
      tags: ["Mafia", "Meeting", "Killing", "Last Two", "AnonymizeMeeting","Visiting","Hostile"],
      description: [
    ...
    Anarchist: {
      alignment: "Independent",
      tags: ["Items", "Killing", "Revealing", "Last Two", "Mini-Game","Visiting","Hostile"],
      description: [
    ...
    "Polar Bear": {
      alignment: "Independent",
      tags: ["Killing", "Last Two", "Visits", "Malicious Effects","Visiting","Hostile"],
      description: [
