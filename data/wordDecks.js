...
const fruitsVeggies = [
  ...
  "pear","peach","pineapple","watermelon","mango","kiwi",
  "raspberry","plum","coconut","pomegranate",
  "carrot","potato","tomato","onion","garlic","broccoli","cauliflower",
  "cucumber","pepper","corn","cabbage","lettuce",
  "mushroom","pumpkin","eggplant",
  "zucchini","asparagus","chili","avocado","squash","melon",
];
...
const vehicles = [
  "car","truck","bus","taxi","bicycle","motorcycle","scooter",
  "skateboard","train","plane","helicopter",
  "rocket","spaceship","ufo","hot-air-balloon",
  "boat","ship","kayak","submarine","sailboat",
  "tractor","bulldozer","crane","forklift","ambulance","firetruck",
  "limousine","cart","sled","snowmobile","tank","rickshaw",
];
