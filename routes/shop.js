...
const shopItems = [
  ...
  },
  {
    ...
    desc: "Play GIF/WebP animations on your family profile picture (up to 25 MB). Without this, GIFs freeze to a still frame. Leader must own Create Family.",
    key: "familyAnimatedAvatar",
    category: "site",
    price: 100,
    limit: 1,
    disableOn: (user) => !user.itemsOwned.createFamily,
    onBuy: async function (userId) {},
  },
  {
    name: "Family Banner",
    desc: "Upload a 3:1 banner on your family page (same proportions as profile banners). Leader only.",
    key: "familyBanner",
    category: "site",
    price: 100,
    limit: 1,
  ...
  },
  {
    ...
    desc: "Play GIF/WebP animations on your family banner (up to 20 MB). Requires Family Banner.",
    key: "familyAnimatedBanner",
    category: "site",
    price: 100,
    limit: 1,
    disableOn: (user) =>
      !user.itemsOwned.createFamily || !user.itemsOwned.familyBanner,
    onBuy: async function (userId) {},
  },
  {
