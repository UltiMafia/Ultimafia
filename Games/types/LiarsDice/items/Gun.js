      ...
      Shoot: {
        ...
        action: {
          ...
          run: function () {
            ...
            this.game.queueAlert(`:gun: ${this.actor.name} pulls a gun and shoots at ${this.target.name}!`);
            this.game.removeDice(this.target);
            let dice = this.target.rolledDice.pop();
            this.game.allDice -= 1;
            this.game.allRolledDice.splice(this.game.allRolledDice.indexOf(dice),1);
          },
        },
      },
    };
