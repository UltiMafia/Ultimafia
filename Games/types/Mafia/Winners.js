...
module.exports = class MafiaWinners extends Winners {
  ...
  getGroupWinMessage(group, plural) {
    switch (group) {
      ...
      case "Red Mafia":
        return ":rose: The renegade Red Mafia has won, giving the kiss of death to their rivals!";
      case "Ripper":
      ...
      case "Sphinx":
        return ":lion: The riddling Sphinx's song made the town deaf to all mysteries but its own.";
      case "Supervillain":
