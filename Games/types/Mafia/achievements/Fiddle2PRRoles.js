        ...
        var action = new Action({
          ...
          run: function () {
              ...
              if (
                ...
                if(this.game.getRoleAlignment(action.target.role.name) == "Village" && action.target.role.name != "Villager" && !this.achievement.FiddledRoles.includes(action.target.role.name)){
