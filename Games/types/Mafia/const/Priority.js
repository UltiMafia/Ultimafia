...
const PRIORITY_SUPPORT_VISIT_DEFAULT = 130;
const PRIORITY_INVESTIGATIVE_DEFAULT = 150;

const PRIORITY_MIMIC_ROLE = 200;
const PRIORITY_SWAP_ROLES = 230;
const PRIORITY_CONVERT_DEFAULT = 250;

const PRIORITY_BECOME_DEAD_ROLE = 270;
