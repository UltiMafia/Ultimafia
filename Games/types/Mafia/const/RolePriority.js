const { // WINCHECK PRIORITY
    ...
    PRIORITY_LEADER_NINJA, } = require("../const/Priority");
...
Mafia: {
    ...
    Funsmith: {
        ...
        ActionValues: [PRIORITY_ITEM_GIVER_DEFAULT,PRIORITY_EFFECT_GIVER_DEFAULT],
    },
    Gemcutter: {
        ActionNames:["Give Item"],
        ActionValues: [PRIORITY_ITEM_GIVER_DEFAULT],
    ...
    Santa: {
        ...
        ActionValues: [PRIORITY_ITEM_GIVER_DEFAULT-1,PRIORITY_INVESTIGATIVE_DEFAULT],
    },
    Analyst: {
