      ...
      state: function (stateInfo) {
        ...
        var action = new Action({
          ...
          run: function () {
            ...
            if (this.actor.role.data.GuessingPlayers == null || this.actor.role.data.GuessingPlayers.length <= 0) return;
            if (this.actor.role.data.GuessingRoles == null || this.actor.role.data.GuessingRoles.length <= 0) return;
