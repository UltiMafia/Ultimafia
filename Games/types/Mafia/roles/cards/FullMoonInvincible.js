  ...
  constructor(role) {
    ...
    this.listeners = {
      stateEvents: function (stateEvents) {
        ...
        if (this.player.hasAbility(["OnlyWhenAlive"]) && (this.game.getStateName() == "Night" || this.game.getStateName() == "Dawn") && (this.game.stateEvents["Full Moon"] == true)) {
          if (
          ...
          var index = this.player.passiveEffects.indexOf(this.FullMoonImmortalEffect);
          if (index != -1) {
