    ...
    this.actions = [
         ...
         //let randomNumber = 5;
          ...
          switch(randomNumber){
            case 1:
              ...
              if (this.game.getRoleAlignment(player.role.name) == "Independent") {
            ...
            case 2:
              ...
              if (this.game.getRoleAlignment(player.role.name) == "Independent") {
                ...
                player.holdItem("WackyFactionRoleReveal", `Reveal to Independent`);
              }
              }
              return;
              break;
            ...
            case 7:
              ...
              if (this.game.getRoleAlignment(player.role.name) == "Independent") {
                ...
                for(let p of this.game.players){
                  if (this.game.getRoleAlignment(p.role.name) == "Independent"){
      ...
      },
      {
        ...
        run: function () {
          ...
          let teammates = this.game.players.filter((p) => this.game.getRoleAlignment(p.role.name) == "Independent" && p.alive);
