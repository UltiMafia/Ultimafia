module.exports = [
  ...
  // More solo neighbor prompts
  "The last thing $player lost track of was $blank",
  "$player's autobiography would open with the line $blank",
  "The one household appliance $player absolutely cannot live without is $blank",
  "If $player replaced their alarm clock with a sound, it would be $blank",
  "$player's most irrational fear is $blank",
  "The strangest compliment $player has ever received was about their $blank",
  "If $player was trapped in a mall overnight, the first place they'd raid is $blank",
  "The meal $player cannot cook to save their life is $blank",
  "$player's go-to karaoke song is $blank",
  "The skill $player brags about but secretly can't do is $blank",
  "If $player could uninvent one thing, it would be $blank",
  "$player's favorite kind of weather is $blank",
  "The oddest thing in $player's fridge right now is $blank",
  "$player's true spirit animal is secretly $blank",
  "$player has 47 browser tabs open and one of them is $blank",
  "If $player started a podcast, it would be called $blank",
  "A movie $player pretends to have seen is $blank",
  "$player's Spotify Wrapped top song was $blank",
  "A conspiracy theory $player kind of believes is about $blank",
  "If $player went on a reality show, it would be $blank",
  "The last weird thing $player Googled was $blank",
  "The snack $player hoards secretly is $blank",
  "If $player were a cocktail, they'd be $blank",
  "$player's most controversial opinion is about $blank",
  "The childhood toy $player still secretly owns is $blank",
  "If $player had a yacht, it would be named $blank",
  "The thing $player says way too often is $blank",
  "If $player had to end a dance battle, their finishing move would be $blank",
  "$player is weirdly good at $blank",
  "The smell that instantly transports $player back to childhood is $blank",
  "If $player were a Starbucks drink, they'd be $blank",
  "$player's roommate would say their worst habit is $blank",

  // More two-player neighbor prompts
  "If $player and $OtherPlayer were in a heist movie, $player's role would be $blank",
  "$player would let $OtherPlayer borrow their $blank, but only once",
  "$player's secret pet name for $OtherPlayer is $blank",
  "The one movie $player and $OtherPlayer could rewatch forever is $blank",
  "If $player and $OtherPlayer opened a food truck, the signature dish would be $blank",
  "$player's excuse for not answering $OtherPlayer's texts is $blank",
