module.exports = [
  ...
  "The worst piece of life advice you've ever received",
  "A new Pringles flavor that should absolutely not exist",
  "What dogs are actually thinking when they stare at a blank wall",
  "A terrible lie to tell your boss on a Monday morning",
  "The real reason the pharaohs built the pyramids",
  "An uncomfortable first question on a blind date",
  "A rejected original name for the iPhone",
  "Something you never want to hear from your surgeon mid-operation",
  "A bad slogan for a funeral home",
  "A name brand of toothpaste that would never sell",
  "The plot twist of a movie you haven't actually seen",
  "The most cursed item to find in a vending machine",
  "What aliens secretly report back about humans",
  "A truly awful password",
  "A new law that nobody asked for",
  "The worst dish to bring to a potluck",
  "A foolproof way to end a boring meeting early",
  "A thought you only have at 3 a.m.",
  "The most useless app on the App Store is $blank",
  "A terrible reason to start a cult",
  "An uncomfortably honest answer to 'how are you?'",
  "A truly demotivational poster slogan",
  "A cryptic note to leave for your future self",
  "Something you should never say out loud in an elevator",
  "A rejected M&M color",
  "A bad name for a luxury perfume",
  "A very suspicious text to receive from your landlord",
  "The real reason the dinosaurs actually went extinct",
  "A job for someone with too much free time and zero taste",
  "A phrase that makes any sentence sound sinister when added to the end",
  "The worst possible place to propose",
  "A superpower that's somehow worse than having no powers at all",
  "A snack that sounds like a crime",
  "A conspiracy theory you just made up on the spot",
  "An oddly specific genre of YouTube video",
  "The title of your tell-all memoir is $blank",
  "A bad thing to whisper during a moment of silence",
  "An ingredient in a witch's cauldron that isn't remotely scary",

  // More Double Player Prompts
  "$player just challenged $OtherPlayer to a duel over $blank.",
  "$player and $OtherPlayer are secretly co-writing a $blank.",
  "The name of $player and $OtherPlayer's garage band is $blank.",
  "$player caught $OtherPlayer doing $blank in the kitchen.",
  "$player keeps telling everyone that $OtherPlayer is their $blank.",
  "$player and $OtherPlayer just got kicked out of $blank.",
  "$player paid $OtherPlayer $blank for a favor they'll regret.",
  "The reason $player and $OtherPlayer stopped speaking last Thanksgiving was $blank.",
