      ...
      for (let player of this.players) {
        ...
        await models.User.updateOne(
          { id: player.user.id },
          {
            ...
            $set: { stats: player.user.stats, playedGame: true, achievementCount: (player.user.achievements.length), winRate: (player.user.stats["Mafia"].all.wins.count/player.user.stats["Mafia"].all.wins.total) },
            $inc: {
