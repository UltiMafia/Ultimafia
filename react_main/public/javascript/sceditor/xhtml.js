    ...
    function t(t, e, n) {
      ...
      return (
          ...
          function (t) {
            var e,
              ...
              u =
                ...
                (function t(e, n) {
                  ...
                  if (-1 < s.indexOf(r) || "td" === r || !C.canHaveChildren(e))
                    return !1;
                  if (a && /\S|\u00A0/.test(a)) return !1;
                  for (; l--; )
                    if (!t(o[l], n && !e.previousSibling && !e.nextSibling))
                      return !1;
                  return (
            ...
            if (
              ...
              1 === o &&
                T(t, ".sceditor-nlf") &&
                (!g ||
                (!E && 1 === t.childNodes.length && /br/i.test(g.nodeName))
                  ? (u = !0)
        ...
        C.traverse(r, function (t) {
          if (
            t.attributes &&
            ((a = t.nodeName.toLowerCase()), (c = t.attributes.length))
          )
            for (p[a] || (p[a] = g ? w(f["*"], f[a]) : w(v["*"], v[a])); c--; )
              (l = t.attributes[c]),
                ...
                g
                  ? (d =
                      null !== u &&
                      (!Array.isArray(u) || u.indexOf(l.value) < 0))
                  : x &&
                    (d =
                      null === u ||
                      (Array.isArray(u) && -1 < u.indexOf(l.value))),
            ...
            for (; i; )
              (n = i.nextSibling),
                C.isInline(i) && !T(i, ".sceditor-ignore")
                  ? (e ||
                      ((e = t.ownerDocument.createElement("p")),
