...
import {
  getDefaults,
  persistDefaults,
  sortInitialFormFields,
} from "./DefaultValues";
import { Lobbies } from "Constants";

export default function HostBattleship() {
  ...
  const initialFormFields = [
    ...
    {
      label: "Place Ships Length (minutes)",
      ref: "placeShipsLength",
      type: "number",
      showIf: "configureDuration",
      value: defaults.placeShipsLength,
      min: 1,
      max: 10,
      step: 0.5,
    },
    {
      label: "Combat Turn Length (minutes)",
      ref: "combatLength",
      type: "number",
      showIf: "configureDuration",
      value: defaults.combatLength,
      min: 0.5,
      max: 5,
      step: 0.5,
    },
  ...
  function onHostGame(setupId, getFormFieldValue) {
    ...
    if (setupId) {
      const hostPromise = axios.post("/api/game/host", {
        ...
        stateLengths: {
          "Place Ships": getFormFieldValue("placeShipsLength"),
          Combat: getFormFieldValue("combatLength"),
        },
