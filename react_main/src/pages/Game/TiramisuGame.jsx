...
import "../../css/gameTiramisu.css";

export default function TiramisuGame(props) {
  ...
  return (
    <SideMenu
      ...
      content={
        <>
          <TiramisuHistory
            nounHistory={extraInfo.nounHistory}
            currentAdjective={extraInfo.currentAdjective}
...
function TiramisuHistory(props) {
  let nounHistory = props.nounHistory;
  let currentAdjective = props.currentAdjective;
  ...
  return (
    <>
      <div className="tiramisu">
        <div className="tiramisu-word-info">
          <>
            <div className="tiramisu-name">
        ...
        <div className="tiramisu-word-info">
          <>
            <div className="tiramisu-name">Current Adjective</div>
            <div className="tiramisu-input">{currentAdjective}</div>
          </>
        </div>
        <div className="tiramisu-current-history">
          <div className="tiramisu-name">Current Nouns</div>
          <NounHistory nounHistory={nounHistory} />
        </div>
        <div className="tiramisu-scores">
          <div className="tiramisu-name">Current Score</div>
          <div className="tiramisu-scores-wrapper">
...
function NounHistory(props) {
  let nounHistory = props.nounHistory;
  let round = props.round;

  return (
    <>
      <div className="tiramisu-history-group">
        {nounHistory.map((n) => {
          return <Noun noun={n} />;
        })}
      </div>
...
function Noun(props) {
  ...
  return (
    <>
      <div className="tiramisu-input tiramisu-tick">
        <span> {n.display} </span> {n.name}
      </div>
    </>
  );
}

function TiramisuScore(props) {
  let name = props.name;
  ...
  return (
    <>
      <div className="tiramisu-score">
        <div className="tiramisu-voted-check">
          {hasVoted && <i className="fas fa-check" />}
        </div>
        <div className="tiramisu-score-data tiramisu-score-score">
          {score}
        </div>
        <div className="tiramisu-score-data tiramisu-score-name">{name}</div>
      </div>
    </>
  );
}
