...
export default function CardFishingGame(props) {
  ...
  return (
    <SideMenu
      ...
      content={
        <>
          <CardFishingHistory
            cards={extraInfo.cards}
            points={extraInfo.points}
          />
        </>
      }
    />
...
function CardFishingHistory(props) {
...
function CardFishingPoints(props) {
  let name = props.name;
  let points = props.points;
