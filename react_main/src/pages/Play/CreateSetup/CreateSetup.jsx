...
export default function CreateSetup(props) {
	...
	function onAddRole(role) {
		updateRoleData({
			type: "addRole",
			role: `${role.name}:${modifiers.filter(e => e).length > 0 ? modifiers.filter(e => e).join("_") : ""}`,
  ...
  function getCompatibleModifiers(...selectedModifiers) {
    const mappedMods = selectedModifiers.map(e => gameModifiers.find(x => x.name === e));
		...
		<div className="span-panel main create-setup">
			...
			{user.loggedIn &&
                ...
                <div className="modifiers-select">
                  ...
                  {modifiers[0] && <div className="field-wrapper">
                    <div className="label">
                      Modifier 2
                    </div>
                    <select
                  ...
                  {modifiers[1] && <div className="field-wrapper">
                    <div className="label">
                      Modifier 3
                    </div>
                    <select
