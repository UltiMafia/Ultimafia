...
export const PieChart = ({ data, colors, displayPieChart }) => {
  ...
  useEffect(() => {
    ...
    svg.selectAll("text").data(data_ready)
      .enter()
      .append("text")
    ...
    svg
      ...
      .attr('transform', function(d) {
        return `translate(${-1 * xRectPadding + d.dx}, -${d.bbox.height * 0.8 + yRectPadding})`
      });
    ...
    svg.selectAll("potato.pointer").data(data_ready).enter()
      .append("path")
      .attr("class", "pointer")
      .style("fill", "none")
      .style("stroke", "black")
