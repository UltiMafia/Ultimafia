      ...
      <div className="learn">
        <Accordion>
          ...
          <AccordionDetails>
            ...
            <Typography paragraph>
              The year is 1932. The place is pre-WWII Germany. In Secret
              Dictator, players are German politicians attempting to hold a
              fragile Liberal government together and stem the rising tide of
              Fascism. Watch out though—there are secret Fascists among you, and
              one player is Secret Dictator.
            </Typography>
            <Typography paragraph>
              At the beginning of the game, each player is secretly assigned to
              one of three roles: Liberal, Fascist, or the Dictator. The
              Liberals have a majority, but they don’t know for sure who anyone
              is; Fascists must resort to secrecy and sabotage to accomplish
              their goals. The Dictator plays for the Fascist team, and the
              Fascists know the Dictator’s identity from the outset, but most of
              the time, the Dictator doesn’t know the Fascists and must work to
              figure them out.
            </Typography>
            <Typography paragraph>
              ...
              the Dictator is elected Chancellor after three Fascist Policies
              have been enacted.
            </Typography>
            <Typography paragraph>
