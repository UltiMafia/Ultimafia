      ...
      <div className="learn">
        <Accordion>
          ...
          <AccordionDetails>
            ...
            <Typography paragraph>
              Each player takes a turn giving a clue related to the word to
              reveal themselves to other villagers without revealing the word to
              the ghosts. After each round of clues a person is voted out as the
