        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography paragraph>
              All players are given a prompt and tasked to answer it! All
              players then vote for their favorites, with the winners of each
              round getting points. The person with the most points at the end
            ...
            <Typography paragraph>
              ...
              with funny prompts that could have been given to get those
              answers!
            </Typography>
            <Typography paragraph>
              ...
              and the true answerer gets 2 points when players guess their
              answer!
            </Typography>
          </AccordionDetails>
        </Accordion>
