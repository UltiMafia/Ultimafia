      ...
      <div className="learn">
        <Accordion>
          ...
          <AccordionDetails>
            ...
            <Typography paragraph>
              One Night is a game of logical deduction similar to Mafia, but
              with only one Night and one Day phase.
            </Typography>
            <Typography paragraph>
              ...
              The one night is typically eventful; the role you are given at the
              beginning of the night may not be the card you end up with.
              Actions will all take place at once at the end of the night. The
              order of events is given by times in the role descriptions.
            </Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion>
